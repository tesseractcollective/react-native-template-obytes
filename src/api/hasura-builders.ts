...
import type { Exact, InputMaybe, Scalars } from '../../generated/user-hooks'
...
export function buildItemsWithAggregateQuery(typeName: string, fragmentDoc: DocumentNode): string {
...
export function buildOrderBy(sortField?: string, sortOrder?: SortOrder): Record<string, string> | undefined {
